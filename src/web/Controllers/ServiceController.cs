namespace Yojowa.StopByStop.Web.Controllers
{
    ...
    public class ServiceController : Controller, IRouteService, IPlacesService
    {
        ...
        {
            return Json(((IRouteService)this).GetJunctionFromOSMID(osmId, populatePOICategories));
        }
        ...
        {
            return Json(((IRouteService)this).GetLastRoutes());
        }
        ...
        public JsonResult GetPoisInArea(string poiAreaString, bool primaryFieldsOnly)
        {
            ...
            return Json(((IRouteService)this).GetPoisInArea(poiArea, primaryFieldsOnly));
        }
        ...
        public JsonResult GetPois(string poiIdsString, bool primaryFieldsOnly)
        {
            ...
            return Json(((IRouteService)this).GetPois(poiIds, primaryFieldsOnly));
        }
        ...
        {
            return Json(((IRouteService)this).GetReviews(SBSID));
        }
        #endregion
        ...
        public JsonResult GetRoute(string routeId, string startString, string endString, string routeOptionsString)
        {
            ...
            return Json(((IRouteService)this).GetRoute(routeId, start, end, routeOptions));
        }
        ...
        public JsonResult UpdateRouteProgress(string routeId, string currentLocationString)
        {
            ...
            return Json(((IRouteService)this).UpdateRouteProgress(routeId, currentLocation));
        }
        ...
        {
            return Json(((IRouteService)this).GetMetadata());
        }
        ...
        public JsonResult GetPoiReviewData(string areaString)
        {
            ...
            return Json(((IRouteService)this).GetPoiReviewData(area));
        }
        ...
        {
            return Json(((IPlacesService)this).GetPlaceById(placeId));
        }
        ...
        {
            return Json(((IPlacesService)this).FindPlacesByPartialMatch(name, maxItems));
        }
        ...
        public JsonResult FindPlacesInArea(string locationString, int maxItems)
        {
            ...
            return Json(((IPlacesService)this).FindPlacesInArea(location, maxItems));
        }
        ...
        {
            return Json(((IPlacesService)this).GetLocationFromPlaceId(placeId));
        }
